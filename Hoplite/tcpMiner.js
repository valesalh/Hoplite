...
const { Block, Miner, Transaction, Blockchain, FakeNet } = require('spartan-gold');
...
let address = (minnie.createAddress) ? minnie.createAddress() : minnie.address;
  ...
  Your choice: `, (answer) => {
    ...
    switch (answer.trim().toLowerCase()) {
      ...
      case 'a':
        ...
        console.log(`Created a new address: ${address}`);
        break;
      case 'u':
        minnie.showAllUtxos();
        break;
